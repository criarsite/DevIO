...
namespace DevIO.Controllers
{
    public class EnderecosController : Controller
    {
        ...
        {
            var contexto = _context.Enderecos.Include(e => e.Fornecedor);
        ...
        public async Task<IActionResult> Create([Bind("Logradouro,Numero,Complemento,Bairro,Cep,Cidade,Estado,FornecedorId,Id")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Logradouro,Numero,Complemento,Bairro,Cep,Cidade,Estado,FornecedorId,Id")] Endereco endereco)
        {
            if (id != endereco.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'Contexto.Enderecos'  is null.");
            }
            var endereco = await _context.Enderecos.FindAsync(id);
            if (endereco != null)
            {
